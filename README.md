...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.0.74-9146FF" alt="Version">
...
```bash
sudo apt install ./tomo_0.0.74_amd64.deb   # x86_64
# or
sudo apt install ./tomo_0.0.74_arm64.deb   # ARM64 (Raspberry Pi, etc.)
```
