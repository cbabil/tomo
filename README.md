...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.0.31-9146FF" alt="Version">
...
```bash
sudo dpkg -i tomo_0.0.31_amd64.deb   # x86_64
# or
sudo dpkg -i tomo_0.0.31_arm64.deb   # ARM64 (Raspberry Pi, etc.)
```
