...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.0.41-9146FF" alt="Version">
...
```bash
sudo apt install ./tomo_0.0.41_amd64.deb   # x86_64
# or
sudo apt install ./tomo_0.0.41_arm64.deb   # ARM64 (Raspberry Pi, etc.)
```
